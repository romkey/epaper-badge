...
GxEPD2_3C<GxEPD2_290c, GxEPD2_290c::HEIGHT> display(GxEPD2_290c(/*CS=5*/ CS, /*DC=*/ DC, /*RST=*/ RESET, /*BUSY=*/ BUSY));

void helloWorld(),    helloFullScreenPartialMode(), helloArduino(), drawBitmaps(), showPartialUpdate(), deepSleepTest(), helloEpaper();
...
void drawBitmaps800x600(), drawBitmaps3c128x296(), drawBitmaps3c800x480();
